...
#define STRING_CONFIG_H_AUTHOR "(7/10/22 Ben Schley Sunlu SKR3EZ)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SunluS8"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 147.4 }
